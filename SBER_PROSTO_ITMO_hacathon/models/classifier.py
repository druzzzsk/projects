...
class Classifier:
    ...
    def __init__(self):
        ...
        self.gbc_unobstructed = pi.load(open('checkpoints/gbc_Unobstructed.pkl', 'rb'))
        self.gbc_orthogonal_planes = pi.load(open('checkpoints/gbc_Orthogonal planes.pkl', 'rb'))
        self.gbc_h_bond_bridging = pi.load(open('checkpoints/gbc_H-bonds bridging.pkl', 'rb'))

        self.features_unobstructed = open('checkpoints/result_features/features_Unobstructed.txt','r').read().split('\n')
        self.features_orthogonal_planes = open('checkpoints/result_features/features_Orthogonal planes.txt','r').read().split('\n')
        self.features_h_bond_bridging = open('checkpoints/result_features/features_H-bonds bridging.txt','r').read().split('\n')

        self.min_max_scaler = pi.load(open('checkpoints/min_max_scaler.pkl', 'rb'))
